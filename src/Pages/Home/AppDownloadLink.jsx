  ...
  return (
    <div className="hero max-h-fit max-w-screen-2xl mx-auto rounded-lg my-10 bg-[#FFDA77] p-6">
      <div className="hero-content grid grid-cols-1">
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl lg:text-5xl font-bold">
              Get JussEatIt in your phone
            </h1>
            <p className="py-6 text-justify lg:w-1/2">
              {
        ...
        <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row items-center justify-center">
          <img
            className="w-32"
